      ...
      <div className="navbar max-w-7xl px-4 md:px-10 min-h-[70px]">
        <div className="navbar-start">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            <div className="bg-gradient-to-br from-primary to-primary-focus p-2 rounded-xl shadow-lg shadow-primary/20 group-hover:rotate-6 transition-all duration-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <span className="text-xl font-black tracking-tighter text-base-content">
              O<span className="text-primary font-extrabold">-</span>EXAM
            </span>
          </Link>
        </div>
